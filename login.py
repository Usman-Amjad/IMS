...
class Login_System:
    def __init__(self, root):
        self.root = root
        self.root.title("Login System | Developed By UA")
        ...
        # ===== Images =====
        self.bkg_img = ImageTk.PhotoImage(file="images/img2.jpg")
        self.lbl_image = Label(self.root, image=self.bkg_img).pack(side=LEFT, fill=BOTH)


        # ===== Login Frame =====
        login_frame = Frame(self.root, bd=2, relief=RIDGE, bg="white")
        login_frame.place(x=800, y=100, width=350, height=460)
        ...
        or_ = Label(login_frame, text="OR", bg="white", fg="lightgray", font=("times new rman", 15, "bold")).place(x=150, y=355)
    ...
    def login(self):
        ...
        try:
            if self.employee_id.get() == "" or self.password.get() == "":
                ...
                cursor.execute("SELECT utype FROM employee WHERE eid=? AND pass=?", (self.employee_id.get(), self.password.get()))
    ...
    def forget_window(self):
        ...
        try:
            if self.employee_id.get() == "":
                ...
                cursor.execute("SELECT email FROM employee WHERE eid=?",
                ...
                if email == None:
                    ...
                    self.forget_win.title("RESER PASSWORD")
                    ...
                    txt_conf_pass = Entry(self.forget_win, textvariable=self.var_conf_pass, font=("times new roman", 15),
