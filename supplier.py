...
class supplierClass:
    def __init__(self,root):
        ...
        btn_search = Button(self.root, text="Search", command=self.search, font=("goudy old style", 15), bg="#4caf50", fg="white", cursor="hand2").place(x=960, y=79, width=100, height=28)
        ...
        self.txt_desc = Text(self.root, font=("goudy old style", 15),
                          bg="lightyellow")
